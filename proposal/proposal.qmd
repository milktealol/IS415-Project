...
Geographical accessibility and spatial interaction models are important considerations for any transportation network, and this is especially true for Singapore. These systems provide an essential transportation link for commuters across the city-state, and its accessibility can have a significant impact on the overall mobility and quality of life of residents.
...
-   **Measuring Accessibility:** The next step would be to measure accessibility. This can be done using the 3 different methods: Hansen, KD2SFCA & SAM

## Datasets

| Data                | Source                                                                                                                  | Type |
|------------------------|------------------------|------------------------|
| Population Density  | [data.gov.sg](https://data.gov.sg/dataset/sample-household-survey-hdb-resident-population-by-geographical-distribution) | CSV  |
| Singapore Zoning    | [data.gov.sg](https://data.gov.sg/dataset/master-plan-2019-planning-area-boundary-no-sea)                               | SHP  |
| Primary Schools     | [data.gov.sg](https://data.gov.sg/dataset/school-directory-and-information)                                             | CSV  |
| MRT & LRT Stations  | [LTA Datamall](https://datamall.lta.gov.sg/content/datamall/en/static-data.html)                                        | SHP  |
| Hawker Centres      | [OneMap](https://www.onemap.gov.sg/main/v2/themes)                                                                      | SHP  |
| Childcare Centres   | [OneMap](https://www.onemap.gov.sg/main/v2/themes)                                                                      | SHP  |
| Kindergartens       | [OneMap](https://www.onemap.gov.sg/main/v2/themes)                                                                      | SHP  |
| Parks               | [OneMap](https://www.onemap.gov.sg/main/v2/themes)                                                                      | SHP  |
| Eldercare           | [OneMap](https://www.onemap.gov.sg/main/v2/themes)                                                                      | SHP  |
| Supermarket         | [OneMap](https://www.onemap.gov.sg/main/v2/themes)                                                                      | SHP  |
| Tourist Attractions | [OneMap](https://www.onemap.gov.sg/main/v2/themes)                                                                      | SHP  |
| Shopping Malls      | [Wikipedia](https://en.wikipedia.org/wiki/List_of_shopping_malls_in_Singapore)                                          | CSV  |
...
Our plan is to create a RShiny application that follows these layouts.

![](images/storyboard0.jpg){fig-align="center"}

All the other tabs like Hansen, KD2SFCA, and SAM Method will follow this layout below.

![](images/storyboard1.jpg){fig-align="center"}

## Application Architecture

![](images/Colorful%20Minimalist%20Business%20Plan%20Infographic%20Chart.gif){fig-align="center" width="537"}
